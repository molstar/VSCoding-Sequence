...
function computeInterUnitBonds(structure, props) {
    ...
    return findBonds(structure, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, p), { validUnitPair: (props && props.validUnitPair) || (function (s, a, b) {
            ...
            return structure_1.Structure.validUnitPair(s, a, b) && (notWater || !p.ignoreWater);
        }) }));
}
