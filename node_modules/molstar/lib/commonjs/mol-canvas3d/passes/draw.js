...
class DrawPass {
    ...
    _renderDpoit(renderer, camera, scene, iterations, transparentBackground, postprocessingProps) {
        ...
        const outlineEnabled = postprocessing_1.PostprocessingPass.isEnabled(postprocessingProps) && postprocessing_1.PostprocessingPass.isTransparentOutlineEnabled(postprocessingProps);
        const dofEnabled = dof_1.DofPass.isEnabled(postprocessingProps);
