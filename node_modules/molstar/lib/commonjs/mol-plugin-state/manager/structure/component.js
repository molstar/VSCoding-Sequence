                        ...
                        return (0, tslib_1.__generator)(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    if (xs.length === 0)
                                        return [2 /*return*/];
                                    getLoci = function (s) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () { var _a, _b; return (0, tslib_1.__generator)(this, function (_c) {
                                        switch (_c.label) {
                                            case 0:
    ...
    function getThemeParams(plugin, pivot) {
        ...
        return {
            ...
            action: param_definition_1.ParamDefinition.MappedStatic('color', {
                ...
                reset: param_definition_1.ParamDefinition.EmptyGroup({ label: 'Reset Color' }),
