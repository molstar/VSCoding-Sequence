    ...
    apply: function (_a) {
        ...
        switch (params.type) {
            ...
            case 'spheres':
                ...
                break;
            default: throw new Error("".concat(params.type, " is a not valid complex element."));
        }
...
var ShapeFromPly = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Create shape from PLY', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var shape, props;
            return (0, tslib_1.__generator)(this, function (_a) {
                switch (_a.label) {
