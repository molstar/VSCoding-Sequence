...
export { ShapeFromPly };
declare type CoordinatesFromDcd = typeof CoordinatesFromDcd;
...
declare type TrajectoryFromXYZ = typeof TrajectoryFromXYZ;
...
declare type TrajectoryFromCube = typeof TrajectoryFromCube;
declare const TrajectoryFromCube: StateTransformer<SO.Format.Cube, SO.Molecule.Trajectory, PD.Normalize<{}>>;
declare type TrajectoryFromCifCore = typeof TrajectoryFromCifCore;
...
declare const StructureComplexElement: StateTransformer<SO.Molecule.Structure, SO.Molecule.Structure, PD.Normalize<{
    type: "spheres" | "polymer" | "water" | "branched" | "ligand" | "nucleic" | "protein" | "coarse" | "non-standard" | "atomic-sequence" | "atomic-het";
}>>;
...
declare const StructureComponent: StateTransformer<SO.Molecule.Structure, SO.Molecule.Structure, PD.Normalize<{
    type: PD.NamedParams<"all" | "polymer" | "water" | "branched" | "ligand" | "ion" | "lipid" | "nucleic" | "protein" | "coarse" | "non-standard", "static"> | PD.NamedParams<Script, "script"> | PD.NamedParams<Expression, "expression"> | PD.NamedParams<StructureElement.Bundle, "bundle">;
...
declare type ShapeFromPly = typeof ShapeFromPly;
