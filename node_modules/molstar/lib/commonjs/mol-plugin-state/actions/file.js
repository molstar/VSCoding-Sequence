        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    plugin.behaviors.layout.leftPanelTabName.next('data');
                    return [4 /*yield*/, state.transaction(function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                            var data, zippedFiles, _i, _a, _b, fn, filedata, asset, url, info, provider, data, parsed, e_2;
                            var _c, _d, _e;
                            return tslib_1.__generator(this, function (_f) {
                                switch (_f.label) {
                                    ...
                                    case 7:
                                        ...
                                        info = (0, file_info_1.getFileInfo)(url);
                                        return [4 /*yield*/, processFile(assets_1.Asset.File(new File([(_d = data.obj) === null || _d === void 0 ? void 0 : _d.data], info.name)), plugin, 'auto', params.visuals)];
                                    case 8:
                                        _f.sent();
                                        _f.label = 9;
