...
export declare namespace TrajectoryHierarchyPresetProvider {
    ...
    const CommonParams: (a: PluginStateObject.Molecule.Trajectory | undefined, plugin: PluginContext) => {
        ...
        representationPreset: PD.Base<"auto" | "empty" | "illustrative" | "atomic-detail" | "polymer-cartoon" | "polymer-and-ligand" | "protein-and-nucleic" | "coarse-surface" | "auto-lod" | undefined>;
    };
}
