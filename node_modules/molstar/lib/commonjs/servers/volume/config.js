...
exports.ServerConfig = (0, tslib_1.__assign)({}, DefaultServerConfig);
...
exports.LimitsConfig = (0, tslib_1.__assign)({}, DefaultLimitsConfig);
...
var ServerConfigTemplate = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, DefaultServerConfig), { idMap: [
...
function configureServer() {
    ...
    try {
        ...
        if (config.printCfg) {
            console.log(JSON.stringify((0, tslib_1.__assign)((0, tslib_1.__assign)({}, exports.ServerConfig), exports.LimitsConfig), null, 2));
            process.exit(0);
        }
