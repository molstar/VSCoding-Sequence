...
export declare type QueryOutputStream = Writer & {
    end: () => void;
};
...
export declare type QueryParamsBox = QueryParamsBox.Cartesian | QueryParamsBox.Fractional | QueryParamsBox.Cell;
...
export declare type QueryBlock = {
...
export declare type QueryContext = QueryContext.Error | QueryContext.Empty | QueryContext.Data;
