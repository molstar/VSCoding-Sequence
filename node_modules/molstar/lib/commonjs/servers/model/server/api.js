...
var QueryMap = {
    ...
    'ligand': Q({
        ...
        query: function (p, _s, numModels) {
            ...
            var ligands = structure_1.Queries.combinators.merge(tests.map(function (test) { return structure_1.Queries.generators.atoms((0, tslib_1.__assign)((0, tslib_1.__assign)({}, test), { unitTest: function (ctx) { return structure_1.StructureProperties.unit.model_num(ctx.element) === numModels[0]; }, groupBy: function (ctx) { return structure_1.StructureProperties.residue.key(ctx.element); } })); }));
    ...
    'residueInteraction': Q({
        ...
        query: function (p) {
            var tests = (0, atoms_1.getAtomsTests)(p.atom_site);
            var center = structure_1.Queries.combinators.merge(tests.map(function (test) { return structure_1.Queries.generators.atoms((0, tslib_1.__assign)((0, tslib_1.__assign)({}, test), { entityTest: test.entityTest
        ...
        restParams: (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], exports.AtomSiteTestRestParams, true), [RadiusParam, AssemblyNameParam], false),
    ...
    'residueSurroundings': Q({
        ...
        restParams: (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], exports.AtomSiteTestRestParams, true), [RadiusParam], false),
        filter: schemas_1.QuerySchemas.interaction
    }),
    'surroundingLigands': Q({
        ...
        restParams: (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], exports.AtomSiteTestRestParams, true), [RadiusParam, OmitWaterParam, AssemblyNameParam], false),
        filter: schemas_1.QuerySchemas.interaction
    }),
};
