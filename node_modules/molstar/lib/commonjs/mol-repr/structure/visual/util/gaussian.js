...
exports.GaussianDensityParams = (0, tslib_1.__assign)({ resolution: param_definition_1.ParamDefinition.Numeric(1, { min: 0.1, max: 20, step: 0.1 }, (0, tslib_1.__assign)({ description: 'Grid resolution/cell spacing.' }, base_1.BaseGeometry.CustomQualityParamInfo)), radiusOffset: param_definition_1.ParamDefinition.Numeric(0, { min: 0, max: 10, step: 0.1 }, { description: 'Extra/offset radius added to the atoms/coarse elements for gaussian calculation. Useful to create coarse, low resolution surfaces.' }), smoothness: param_definition_1.ParamDefinition.Numeric(1.5, { min: 0.5, max: 2.5, step: 0.1 }, { description: 'Smoothness of the gausian surface, lower is smoother.' }) }, common_1.CommonSurfaceParams);
...
//
function computeUnitGaussianDensity(structure, unit, props) {
    var _this = this;
    var box = unit.lookup3d.boundary.box;
    var p = (0, common_1.ensureReasonableResolution)(box, props);
    var _a = (0, common_1.getUnitConformationAndRadius)(structure, unit, p), position = _a.position, radius = _a.radius;
...
function computeUnitGaussianDensityTexture(structure, unit, props, webgl, texture) {
    var _this = this;
    var box = unit.lookup3d.boundary.box;
...
function computeUnitGaussianDensityTexture2d(structure, unit, powerOfTwo, props, webgl, texture) {
    var _this = this;
    var box = unit.lookup3d.boundary.box;
    var p = (0, common_1.ensureReasonableResolution)(box, props, getTextureMaxCells(webgl, structure));
    var _a = (0, common_1.getUnitConformationAndRadius)(structure, unit, p), position = _a.position, radius = _a.radius;
...
//
function computeStructureGaussianDensity(structure, props) {
    var _this = this;
    var box = structure.lookup3d.boundary.box;
    var p = (0, common_1.ensureReasonableResolution)(box, props);
    var _a = (0, common_1.getStructureConformationAndRadius)(structure, props.ignoreHydrogens, props.traceOnly), position = _a.position, radius = _a.radius;
    return mol_task_1.Task.create('Gaussian Density', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, cpu_1.GaussianDensityCPU)(ctx, position, box, radius, p)];
...
function computeStructureGaussianDensityTexture(structure, props, webgl, texture) {
    var _this = this;
    var box = structure.lookup3d.boundary.box;
...
function computeStructureGaussianDensityTexture2d(structure, powerOfTwo, props, webgl, texture) {
    var _this = this;
    var box = structure.lookup3d.boundary.box;
    var p = (0, common_1.ensureReasonableResolution)(box, props, getTextureMaxCells(webgl));
    var _a = (0, common_1.getStructureConformationAndRadius)(structure, props.ignoreHydrogens, props.traceOnly), position = _a.position, radius = _a.radius;
