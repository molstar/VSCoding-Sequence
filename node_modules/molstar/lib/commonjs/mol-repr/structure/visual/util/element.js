...
function createElementSphereMesh(ctx, unit, structure, theme, props, mesh) {
    ...
    if (mesh && linear_algebra_1.Vec3.distance(center, mesh.boundingSphere.center) / mesh.boundingSphere.radius < 1.0) {
        boundingSphere = geometry_1.Sphere3D.clone(mesh.boundingSphere);
    }
    else {
...
function createElementSphereImpostor(ctx, unit, structure, theme, props, spheres) {
    ...
    var boundingSphere;
    linear_algebra_1.Vec3.scale(center, center, 1 / count);
    if (spheres && linear_algebra_1.Vec3.distance(center, spheres.boundingSphere.center) / spheres.boundingSphere.radius < 1.0) {
        boundingSphere = geometry_1.Sphere3D.clone(spheres.boundingSphere);
    }
    else {
