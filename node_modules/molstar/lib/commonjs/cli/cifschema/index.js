        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    frames = (0, tslib_1.__spreadArray)([], cifCoreDic.result.blocks[0].saveFrames, true);
        ...
        return (0, tslib_1.__generator)(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (dic.isError)
                        throw dic;
                    imports.set(file, (0, tslib_1.__spreadArray)([], dic.result.blocks[0].saveFrames, true));
                    _b.label = 4;
                case 4:
                    _a++;
                    return [3 /*break*/, 2];
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    frames = (0, tslib_1.__spreadArray)([], dic.result.blocks[0].saveFrames, true);
