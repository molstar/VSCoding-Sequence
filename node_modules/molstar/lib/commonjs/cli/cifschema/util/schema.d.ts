...
export declare type Column = IntCol | StrCol | FloatCol | CoordCol | EnumCol | VectorCol | MatrixCol | ListCol;
declare type BaseCol = {
    description: string;
};
export declare type IntCol = {
    type: 'int';
} & BaseCol;
export declare function IntCol(description: string): IntCol;
export declare type StrCol = {
    type: 'str';
} & BaseCol;
export declare function StrCol(description: string): StrCol;
export declare type FloatCol = {
    type: 'float';
} & BaseCol;
export declare function FloatCol(description: string): FloatCol;
export declare type CoordCol = {
    type: 'coord';
} & BaseCol;
