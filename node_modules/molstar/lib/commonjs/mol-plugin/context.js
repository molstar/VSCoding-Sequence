...
var PluginContext = /** @class */ (function () {
    ...
    PluginContext.prototype.initContainer = function (canvas3dContext) {
        ...
        var canvas = canvas3dContext === null || canvas3dContext === void 0 ? void 0 : canvas3dContext.canvas;
        if (!canvas) {
    ...
    PluginContext.prototype.mount = function (target) {
        var _a;
        if (this.disposed)
    ...
    PluginContext.prototype.initViewer = function (canvas, container, canvas3dContext) {
        ...
        try {
            ...
            if (canvas3dContext) {
                ...
                this.canvas3dContext = canvas3d_1.Canvas3DContext.fromCanvas(canvas, this.managers.asset, { antialias: antialias, preserveDrawingBuffer: preserveDrawingBuffer, pixelScale: pixelScale, pickScale: pickScale, pickPadding: pickPadding, enableWboit: enableWboit, enableDpoit: enableDpoit, preferWebGl1: preferWebGl1, failIfMajorPerformanceCaveat: failIfMajorPerformanceCaveat });
            }
