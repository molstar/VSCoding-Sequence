...
var Sort = (0, tslib_1.__importStar)(require("../util/sort"));
...
function shuffleArray(data) {
    return shuffle(data, data.length, function (t) { return (0, tslib_1.__spreadArray)([], t, true); });
}
    ...
    function test(name, data, randomize) {
        it(name, function () {
            ...
            if (randomize) {
                ...
                expect(Sort.sortArray((0, tslib_1.__spreadArray)([], data, true))).toEqual(data);
            }
        });
    }
    ...
    function test(name, data, randomize) {
        it(name, function () {
            ...
            if (randomize) {
                ...
                expect(Sort.sort((0, tslib_1.__spreadArray)([], data, true), 0, data.length, Sort.arrayLess, Sort.arraySwap)).toEqual(data);
            }
        });
    }
    test('uniq', data0, false);
...
describe('qsort-dual array', function () {
    ...
    var clone = function (d) { return ({ xs: (0, tslib_1.__spreadArray)([], d.xs, true), ys: (0, tslib_1.__spreadArray)([], d.ys, true) }); };
