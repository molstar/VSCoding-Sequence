...
})(ArrayEncoder || (exports.ArrayEncoder = ArrayEncoder = {}));
var ArrayEncoding;
(function (ArrayEncoding) {
    ...
    const writers = {
        [encoding_1.Encoding.IntDataType.Int16]: function (v, i, a) { v.setInt16(2 * i, a, true); },
        [encoding_1.Encoding.IntDataType.Uint16]: function (v, i, a) { v.setUint16(2 * i, a, true); },
        [encoding_1.Encoding.IntDataType.Int32]: function (v, i, a) { v.setInt32(4 * i, a, true); },
        [encoding_1.Encoding.IntDataType.Uint32]: function (v, i, a) { v.setUint32(4 * i, a, true); },
        [encoding_1.Encoding.FloatDataType.Float32]: function (v, i, a) { v.setFloat32(4 * i, a, true); },
        [encoding_1.Encoding.FloatDataType.Float64]: function (v, i, a) { v.setFloat64(8 * i, a, true); }
    };
    const byteSizes = {
        [encoding_1.Encoding.IntDataType.Int16]: 2,
        [encoding_1.Encoding.IntDataType.Uint16]: 2,
        [encoding_1.Encoding.IntDataType.Int32]: 4,
        [encoding_1.Encoding.IntDataType.Uint32]: 4,
        [encoding_1.Encoding.FloatDataType.Float32]: 4,
        [encoding_1.Encoding.FloatDataType.Float64]: 8
    };
    function byteArray(data) {
        const type = encoding_1.Encoding.getDataType(data);
    ...
    function _fixedPoint(data, factor) {
        const srcType = encoding_1.Encoding.getDataType(data);
    ...
    function runLength(data) {
        let srcType = encoding_1.Encoding.getDataType(data);
        if (srcType === void 0) {
    ...
    function stringArray(data) {
        ...
        const offsets = util_1.ChunkedArray.create(Int32Array, 1, Math.min(1024, data.length < 32 ? data.length + 1 : Math.round(data.length / 8) + 1));
        ...
        const offsetArray = util_1.ChunkedArray.compact(offsets);
        const offsetEncoding = (0, classifier_1.classifyIntArray)(offsetArray);
        const encodedOddsets = offsetEncoding.encode(offsetArray);
        const dataEncoding = (0, classifier_1.classifyIntArray)(output);
...
})(ArrayEncoding || (exports.ArrayEncoding = ArrayEncoding = {}));
