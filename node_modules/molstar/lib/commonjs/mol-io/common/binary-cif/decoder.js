    ...
    switch (encoding.kind) {
        case 'ByteArray': {
            switch (encoding.type) {
                case 4 /* Encoding.IntDataType.Uint8 */: return data;
                case 1 /* Encoding.IntDataType.Int8 */: return int8(data);
                case 2 /* Encoding.IntDataType.Int16 */: return int16(data);
                case 5 /* Encoding.IntDataType.Uint16 */: return uint16(data);
                case 3 /* Encoding.IntDataType.Int32 */: return int32(data);
                case 6 /* Encoding.IntDataType.Uint32 */: return uint32(data);
                case 32 /* Encoding.FloatDataType.Float32 */: return float32(data);
                case 33 /* Encoding.FloatDataType.Float64 */: return float64(data);
...
function getIntArray(type, size) {
    switch (type) {
        case 1 /* Encoding.IntDataType.Int8 */: return new Int8Array(size);
        case 2 /* Encoding.IntDataType.Int16 */: return new Int16Array(size);
        case 3 /* Encoding.IntDataType.Int32 */: return new Int32Array(size);
        case 4 /* Encoding.IntDataType.Uint8 */: return new Uint8Array(size);
        case 5 /* Encoding.IntDataType.Uint16 */: return new Uint16Array(size);
        case 6 /* Encoding.IntDataType.Uint32 */: return new Uint32Array(size);
        default: (0, type_helpers_1.assertUnreachable)(type);
    }
}
function getFloatArray(type, size) {
    switch (type) {
        case 32 /* Encoding.FloatDataType.Float32 */: return new Float32Array(size);
        case 33 /* Encoding.FloatDataType.Float64 */: return new Float64Array(size);
        default: (0, type_helpers_1.assertUnreachable)(type);
    }
}
