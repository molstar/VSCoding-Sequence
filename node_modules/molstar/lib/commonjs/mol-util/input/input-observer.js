...
(function (InputObserver) {
    function create(props) {
        ...
        return tslib_1.__assign(tslib_1.__assign({ noScroll: noScroll, noContextMenu: noContextMenu, width: 0, height: 0, pixelRatio: 1 }, createEvents()), { dispose: mol_util_1.noop });
    }
    ...
    function fromElement(element, props) {
        ...
        var dragging = 0 /* DraggingState.Stopped */;
        var disposed = false;
        var buttons = ButtonsType.create(0 /* ButtonsType.Flag.None */);
        var button = 0 /* ButtonsType.Flag.None */;
        var isInside = false;
        var hasMoved = false;
        ...
        function onTouchStart(ev) {
            ...
            if (ev.touches.length === 1) {
                buttons = button = 1 /* ButtonsType.Flag.Primary */;
                onPointerDown(ev.touches[0]);
            }
            else if (ev.touches.length === 2) {
                buttons = 2 /* ButtonsType.Flag.Secondary */ & 4 /* ButtonsType.Flag.Auxilary */;
                button = 2 /* ButtonsType.Flag.Secondary */;
                ...
                buttons = button = 8 /* ButtonsType.Flag.Forth */;
                onPointerDown(getCenterTouch(ev));
            }
        }
        ...
        function onTouchMove(ev) {
            button = 0 /* ButtonsType.Flag.None */;
            if (noPinchZoom) {
                ev.preventDefault();
                ev.stopPropagation();
                if (ev.originalEvent) {
            ...
            if (ev.touches.length === 1) {
                buttons = 1 /* ButtonsType.Flag.Primary */;
                ...
                if (Math.abs(touchDelta) < 4) {
                    buttons = 2 /* ButtonsType.Flag.Secondary */;
                    onPointerMove(getCenterTouch(ev));
                }
                else {
                    buttons = 4 /* ButtonsType.Flag.Auxilary */;
                ...
                buttons = 8 /* ButtonsType.Flag.Forth */;
                onPointerMove(getCenterTouch(ev));
            }
        }
        function onMouseDown(ev) {
            ...
            button = getButton(ev);
            if (noMiddleClickScroll && buttons === 4 /* ButtonsType.Flag.Auxilary */) {
                ev.preventDefault;
            }
            onPointerDown(ev);
        }
        ...
        function onPointerDown(ev) {
            ...
            if (insideBounds(pointerStart)) {
                dragging = 1 /* DraggingState.Started */;
            }
        }
        function onPointerUp(ev) {
            dragging = 0 /* DraggingState.Stopped */;
            if (!mask(ev.clientX, ev.clientY))
                return;
        ...
        function onPointerMove(ev) {
            ...
            if (dragging === 0 /* DraggingState.Stopped */)
                return;
            if (noTextSelect) {
            ...
            if (linear_algebra_1.Vec2.magnitude(pointerDelta) < linear_algebra_1.EPSILON)
                return;
            var isStart = dragging === 1 /* DraggingState.Started */;
            ...
            dragging = 2 /* DraggingState.Moving */;
        }
        function onMouseWheel(ev) {
            ...
            buttons = button = 4 /* ButtonsType.Flag.Auxilary */;
