...
var Channel = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(Channel, _super);
    function Channel() {
    ...
    Channel.prototype.render = function () {
        ...
        return (0, jsx_runtime_1.jsx)(common_1.ExpandableControlRow, { label: props.label + (props.isRelative ? ' \u03C3' : ''), colorStripe: channel.color, pivot: (0, jsx_runtime_1.jsxs)("div", (0, tslib_1.__assign)({ className: 'msp-volume-channel-inline-controls' }, { children: [(0, jsx_runtime_1.jsx)(slider_1.Slider, { value: value, min: ctrlMin, max: ctrlMax, step: step, onChange: function (v) { return props.changeIso(props.name, v, isRelative); }, disabled: props.params.isDisabled, onEnter: props.params.events.onEnter }, void 0), (0, jsx_runtime_1.jsx)(common_1.IconButton, { svg: this.getVisible() ? icons_1.VisibilityOutlinedSvg : icons_1.VisibilityOffOutlinedSvg, onClick: this.toggleVisible, toggleState: false, disabled: props.params.isDisabled }, void 0)] }), void 0), controls: (0, jsx_runtime_1.jsx)(parameters_1.ParameterControls, { onChange: function (_a) {
...
var VolumeStreamingCustomControls = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(VolumeStreamingCustomControls, _super);
    function VolumeStreamingCustomControls() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.changeIso = function (name, value, isRelative) {
            var _a;
            var old = _this.props.params;
            _this.newParams((0, tslib_1.__assign)((0, tslib_1.__assign)({}, old), { entry: {
                    name: old.entry.name,
                    params: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, old.entry.params), { channels: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, old.entry.params.channels), (_a = {}, _a[name] = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, old.entry.params.channels[name]), { isoValue: isRelative ? volume_1.Volume.IsoValue.relative(value) : volume_1.Volume.IsoValue.absolute(value) }), _a)) })
                } }));
        };
        _this.changeParams = function (name, param, value) {
            ...
            _this.newParams((0, tslib_1.__assign)((0, tslib_1.__assign)({}, old), { entry: {
                    name: old.entry.name,
                    params: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, old.entry.params), { channels: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, old.entry.params.channels), (_a = {}, _a[name] = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, old.entry.params.channels[name]), (_b = {}, _b[param] = value, _b)), _a)) })
                } }));
        };
        _this.changeOption = function (_a) {
            ...
            if (name === 'entry') {
                ...
                var viewParams = (0, tslib_1.__assign)({}, oldView);
                ...
                _this.newParams((0, tslib_1.__assign)((0, tslib_1.__assign)({}, old), { entry: {
                        name: old.entry.name,
                        params: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, old.entry.params), { view: {
                                name: value.name,
                                params: viewParams
    ...
    VolumeStreamingCustomControls.prototype.convert = function (channel, stats, isRelative) {
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, channel), { isoValue: isRelative
    ...
    VolumeStreamingCustomControls.prototype.render = function () {
        ...
        var OptionsParams = {
            ...
            view: param_definition_1.ParamDefinition.MappedStatic(params.entry.params.view.name, {
                ...
                'auto': param_definition_1.ParamDefinition.Group({
                    radius: param_definition_1.ParamDefinition.Numeric(5, { min: 0, max: 50, step: 0.5 }, { description: 'Radius in \u212B within which the volume is shown.' }),
                    detailLevel: detailLevel,
                    selectionDetailLevel: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, detailLevel), { label: 'Selection Detail' }),
                    isRelative: isRelativeParam,
                    isUnbounded: isUnboundedParam,
                }, { description: 'Box around focused element.' }),
                // 'auto': PD.Group({  }), // TODO based on camera distance/active selection/whatever, show whole structure or slice.
            }, { options: behavior_1.VolumeStreaming.ViewTypeOptions, description: 'Controls what of the volume is displayed. "Off" hides the volume alltogether. "Bounded box" shows the volume inside the given box. "Around Focus" shows the volume around the element/atom last interacted with. "Whole Structure" shows the volume for the whole structure.' })
        };
        var options = {
        ...
        if (isOff) {
            return (0, jsx_runtime_1.jsx)(parameters_1.ParameterControls, { onChange: this.changeOption, params: OptionsParams, values: options, onEnter: this.props.events.onEnter, isDisabled: this.props.isDisabled }, void 0);
        }
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [!isEM && (0, jsx_runtime_1.jsx)(Channel, { label: '2Fo-Fc', name: '2fo-fc', bCell: this.props.bCell, channels: params.entry.params.channels, changeIso: this.changeIso, changeParams: this.changeParams, isRelative: isRelative, params: this.props, stats: sampling.valuesInfo[0], isUnbounded: isUnbounded }, void 0), !isEM && (0, jsx_runtime_1.jsx)(Channel, { label: 'Fo-Fc(+ve)', name: 'fo-fc(+ve)', bCell: this.props.bCell, channels: params.entry.params.channels, changeIso: this.changeIso, changeParams: this.changeParams, isRelative: isRelative, params: this.props, stats: sampling.valuesInfo[1], isUnbounded: isUnbounded }, void 0), !isEM && (0, jsx_runtime_1.jsx)(Channel, { label: 'Fo-Fc(-ve)', name: 'fo-fc(-ve)', bCell: this.props.bCell, channels: params.entry.params.channels, changeIso: this.changeIso, changeParams: this.changeParams, isRelative: isRelative, params: this.props, stats: sampling.valuesInfo[1], isUnbounded: isUnbounded }, void 0), isEM && (0, jsx_runtime_1.jsx)(Channel, { label: 'EM', name: 'em', bCell: this.props.bCell, channels: params.entry.params.channels, changeIso: this.changeIso, changeParams: this.changeParams, isRelative: isRelative, params: this.props, stats: sampling.valuesInfo[0], isUnbounded: isUnbounded }, void 0), (0, jsx_runtime_1.jsx)(parameters_1.ParameterControls, { onChange: this.changeOption, params: OptionsParams, values: options, onEnter: this.props.events.onEnter, isDisabled: this.props.isDisabled }, void 0)] }, void 0);
    };
