...
var ActionMenu = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(ActionMenu, _super);
    function ActionMenu() {
    ...
    ActionMenu.prototype.render = function () {
        var cmd = this.props;
        var section = (0, jsx_runtime_1.jsx)(Section, { items: cmd.items, onSelect: cmd.onSelect, current: cmd.current, multiselect: this.props.multiselect, noOffset: this.props.noOffset, noAccent: this.props.noAccent }, void 0);
        return (0, jsx_runtime_1.jsxs)("div", (0, tslib_1.__assign)({ className: "msp-action-menu-options".concat(cmd.header ? '' : ' msp-action-menu-options-no-header') }, { children: [cmd.header && (0, jsx_runtime_1.jsx)(common_1.ControlGroup, (0, tslib_1.__assign)({ header: cmd.header, title: cmd.title, initialExpanded: true, hideExpander: true, hideOffset: true, onHeaderClick: this.hide, topRightIcon: icons_1.CloseSvg }, { children: section }), void 0), !cmd.header && section] }), void 0);
    };
    return ActionMenu;
}(React.PureComponent));
...
(function (ActionMenu) {
    function Header(label, options) {
        return options ? (0, tslib_1.__assign)({ kind: 'header', label: label }, options) : { kind: 'header', label: label };
    }
    ActionMenu.Header = Header;
    function Item(label, value, options) {
        return (0, tslib_1.__assign)({ kind: 'item', label: label, value: value }, options);
    }
    ...
    function createItemsFromSelectOptions(options, params) {
        return createItems(options, params ? (0, tslib_1.__assign)((0, tslib_1.__assign)({}, _selectOptions), params) : _selectOptions);
    }
...
var Section = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(Section, _super);
    function Section() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
    ...
    Object.defineProperty(Section.prototype, "multiselectHeader", {
        get: function () {
            ...
            return (0, jsx_runtime_1.jsxs)("div", (0, tslib_1.__assign)({ className: 'msp-flex-row msp-control-group-header' }, { children: [(0, jsx_runtime_1.jsx)(common_1.Button, (0, tslib_1.__assign)({ icon: this.state.isExpanded ? icons_1.ArrowDropDownSvg : icons_1.ArrowRightSvg, flex: true, noOverflow: true, onClick: this.toggleExpanded, title: "Click to ".concat(this.state.isExpanded ? 'collapse' : 'expand', ".").concat((header === null || header === void 0 ? void 0 : header.description) ? " ".concat(header === null || header === void 0 ? void 0 : header.description) : '') }, { children: hasCurrent ? (0, jsx_runtime_1.jsx)("b", { children: header === null || header === void 0 ? void 0 : header.label }, void 0) : header === null || header === void 0 ? void 0 : header.label }), void 0), (0, jsx_runtime_1.jsx)(common_1.Button, (0, tslib_1.__assign)({ icon: icons_1.CheckSvg, flex: true, onClick: this.selectAll, style: { flex: '0 0 50px', textAlign: 'right' } }, { children: "All" }), void 0), (0, jsx_runtime_1.jsx)(common_1.Button, (0, tslib_1.__assign)({ icon: icons_1.CloseSvg, flex: true, onClick: this.selectNone, style: { flex: '0 0 50px', textAlign: 'right' } }, { children: "None" }), void 0)] }), void 0);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Section.prototype, "basicHeader", {
        get: function () {
            var _a = this.state, header = _a.header, hasCurrent = _a.hasCurrent;
            return (0, jsx_runtime_1.jsx)("div", (0, tslib_1.__assign)({ className: 'msp-control-group-header', style: { marginTop: '1px' } }, { children: (0, jsx_runtime_1.jsx)(common_1.Button, (0, tslib_1.__assign)({ noOverflow: true, icon: this.state.isExpanded ? icons_1.ArrowDropDownSvg : icons_1.ArrowRightSvg, onClick: this.toggleExpanded, title: "Click to ".concat(this.state.isExpanded ? 'collapse' : 'expand', ". ").concat((header === null || header === void 0 ? void 0 : header.description) ? header === null || header === void 0 ? void 0 : header.description : '') }, { children: hasCurrent ? (0, jsx_runtime_1.jsx)("b", { children: header === null || header === void 0 ? void 0 : header.label }, void 0) : header === null || header === void 0 ? void 0 : header.label }), void 0) }), void 0);
        },
        enumerable: false,
        configurable: true
    });
    Section.prototype.render = function () {
        ...
        if (isHeader(items))
            return null;
        if (isItem(items))
            return (0, jsx_runtime_1.jsx)(Action, { item: items, onSelect: onSelect, current: current, multiselect: this.props.multiselect }, void 0);
        var header = this.state.header;
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [header && (this.props.multiselect && this.state.isExpanded ? this.multiselectHeader : this.basicHeader), (0, jsx_runtime_1.jsx)("div", (0, tslib_1.__assign)({ className: this.props.noOffset ? void 0 : this.props.noAccent ? 'msp-control-offset' : 'msp-accent-offset' }, { children: (!header || this.state.isExpanded) && items.map(function (x, i) {
                        if (isHeader(x))
                            return null;
                        if (isItem(x))
...
var Action = function (_a) {
    ...
    return (0, jsx_runtime_1.jsxs)(common_1.Button, (0, tslib_1.__assign)({ icon: item.icon, noOverflow: true, className: 'msp-action-menu-button', onClick: function (e) { return onSelect(multiselect ? [item] : item, e); }, disabled: item.disabled, style: style, title: item.description }, { children: [isCurrent || item.selected ? (0, jsx_runtime_1.jsx)("b", { children: item.label }, void 0) : item.label, item.addOn] }), void 0);
};
function isItems(x) {
