...
class UpdateTransformControl extends common_1.TransformControlBase {
    constructor() {
        super(...arguments);
        this._getInfo = (0, memoize_1.memoizeLatest)((t) => common_1.StateTransformParameters.infoFromTransform(this.plugin, this.props.state, t));
...
class TransformUpdaterControl extends base_1.PluginUIComponent {
    componentDidMount() {
        this.subscribe(this.plugin.state.events.object.updated, ({ ref, state }) => {
