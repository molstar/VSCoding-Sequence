...
var LeftPanelControls = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(LeftPanelControls, _super);
    function LeftPanelControls() {
        ...
        _this.set = function (tab) {
            ...
            if (_this.plugin.layout.state.regionState.left !== 'full') {
                commands_1.PluginCommands.Layout.Update(_this.plugin, { state: { regionState: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, _this.plugin.layout.state.regionState), { left: 'full' }) } });
            }
        };
        _this.tabs = {
...
var DataIcon = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(DataIcon, _super);
    function DataIcon() {
...
var FullSettings = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(FullSettings, _super);
    ...
    FullSettings.prototype.render = function () {
        return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [this.plugin.canvas3d && (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(common_1.SectionHeader, { title: 'Viewport' }, void 0), (0, jsx_runtime_1.jsx)(parameters_1.ParameterControls, { params: canvas3d_1.Canvas3DParams, values: this.plugin.canvas3d.props, onChange: this.setSettings }, void 0)] }, void 0), (0, jsx_runtime_1.jsx)(common_1.SectionHeader, { title: 'Behavior' }, void 0), (0, jsx_runtime_1.jsx)(tree_1.StateTree, { state: this.plugin.state.behaviors }, void 0)] }, void 0);
    };
    return FullSettings;
}(base_1.PluginUIComponent));
var RemoveAllButton = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(RemoveAllButton, _super);
    ...
    RemoveAllButton.prototype.render = function () {
        ...
        if (count === 0)
            return null;
        return (0, jsx_runtime_1.jsx)(common_1.IconButton, { svg: icons_1.DeleteOutlinedSvg, onClick: this.remove, title: 'Remove All', style: { display: 'inline-block' }, small: true, className: 'msp-no-hover-outline', transparent: true }, void 0);
    };
