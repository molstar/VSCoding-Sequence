...
var UsdzExporter = /** @class */ (function (_super) {
    ...
    UsdzExporter.prototype.addMaterial = function (color, alpha) {
        ...
        this.materials.push("\ndef Material \"material".concat(materialKey, "\"\n{\n    token outputs:surface.connect = </material").concat(materialKey, "/shader.outputs:surface>\n    def Shader \"shader\"\n    {\n        uniform token info:id = \"UsdPreviewSurface\"\n        color3f inputs:diffuseColor = (").concat(r, ",").concat(g, ",").concat(b, ")\n        float inputs:opacity = ").concat(alpha, "\n        float inputs:metallic = ").concat(this.style.metalness, "\n        float inputs:roughness = ").concat(this.style.roughness, "\n        token outputs:surface\n    }\n}\n"));
    };
    UsdzExporter.prototype.addMeshWithColors = function (input) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
            var mesh, values, isGeoTexture, webgl, ctx, t, n, tmpV, stride, colorType, overpaintType, transparencyType, uAlpha, aTransform, instanceCount, interpolatedColors, interpolatedOverpaint, stride_1, interpolatedTransparency, stride_2, _loop_1, this_1, instanceIndex;
