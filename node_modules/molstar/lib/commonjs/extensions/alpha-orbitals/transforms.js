...
var BasisAndOrbitals = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(BasisAndOrbitals, _super);
...
exports.CreateOrbitalVolume = objects_1.PluginStateTransform.BuiltIn({
    ...
    params: function (a) {
        if (!a) {
            return (0, tslib_1.__assign)({ index: param_definition_1.ParamDefinition.Numeric(0) }, CreateOrbitalVolumeParamBase);
        }
        return (0, tslib_1.__assign)({ index: param_definition_1.ParamDefinition.Select(0, a.data.orbitals.map(function (o, i) { return [i, "[".concat(i + 1, "] ").concat(o.energy.toFixed(4))]; })) }, CreateOrbitalVolumeParamBase);
    }
})({
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Orbital Volume', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var data, volume;
            var _a, _b, _c, _d, _e;
...
exports.CreateOrbitalRepresentation3D = objects_1.PluginStateTransform.BuiltIn({
    ...
    apply: function (_a, plugin) {
        ...
        return mol_task_1.Task.create('Orbitals Representation 3D', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
