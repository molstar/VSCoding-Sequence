...
exports.AssemblySymmetryClusterColorThemeParams = (0, tslib_1.__assign)({}, (0, palette_1.getPaletteParams)({ colorList: 'red-yellow-blue' }));
    ...
    if ((clusters === null || clusters === void 0 ? void 0 : clusters.length) && ctx.structure) {
        ...
        for (var i = 0, il = clusters.length; i < il; ++i) {
            ...
            for (var j = 0, jl = members.length; j < jl; ++j) {
                ...
                var operList = (0, tslib_1.__spreadArray)([], members[j].pdbx_struct_oper_list_ids || [], true);
