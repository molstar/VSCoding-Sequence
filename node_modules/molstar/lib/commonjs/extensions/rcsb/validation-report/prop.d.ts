...
declare type FileSourceProps = PD.Values<typeof FileSourceParams>;
declare const ServerSourceParams: {
    baseUrl: PD.Text<string>;
};
declare type ServerSourceProps = PD.Values<typeof ServerSourceParams>;
...
export declare type ValidationReportParams = typeof ValidationReportParams;
export declare type ValidationReportProps = PD.Values<ValidationReportParams>;
export declare const ValidationReportProvider: CustomModelProperty.Provider<ValidationReportParams, ValidationReport>;
declare type IntraUnitClashesProps = {
    readonly id: ArrayLike<number>;
    readonly magnitude: ArrayLike<number>;
    readonly distance: ArrayLike<number>;
};
declare type InterUnitClashesProps = {
    readonly id: number;
    readonly magnitude: number;
    readonly distance: number;
};
export declare type IntraUnitClashes = IntAdjacencyGraph<UnitIndex, IntraUnitClashesProps>;
export declare type InterUnitClashes = InterUnitGraph<number, UnitIndex, InterUnitClashesProps>;
