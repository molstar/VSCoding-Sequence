...
exports.CreateCompartmentSphere = CreateTransformer({
    ...
    apply: function (_a, plugin) {
        var _this = this;
        var a = _a.a, params = _a.params;
        return mol_task_1.Task.create('Compartment Sphere', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
            var data, repr;
            var _a;
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        data = params;
                        repr = (0, representation_1.MBRepresentation)((0, tslib_1.__assign)({ webgl: (_a = plugin.canvas3d) === null || _a === void 0 ? void 0 : _a.webgl }, plugin.representation.structure.themes), function () { return (representation_1.MBParams); });
                        return [4 /*yield*/, repr.createOrUpdate((0, tslib_1.__assign)((0, tslib_1.__assign)({}, params), { quality: 'custom', xrayShaded: true, doubleSided: true }), data).runInContext(ctx)];
                    case 1:
                        _b.sent();
