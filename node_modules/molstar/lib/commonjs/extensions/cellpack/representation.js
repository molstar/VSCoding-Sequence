...
var MembraneSphereParams = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, mesh_1.Mesh.Params), { cellColor: param_definition_1.ParamDefinition.Color(names_1.ColorNames.orange), cellScale: param_definition_1.ParamDefinition.Numeric(2, { min: 0.1, max: 5, step: 0.1 }), radius: param_definition_1.ParamDefinition.Numeric(2, { min: 0.1, max: 5, step: 0.1 }), center: param_definition_1.ParamDefinition.Vec3(linear_algebra_1.Vec3.create(0, 0, 0)), quality: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, mesh_1.Mesh.Params.quality), { isEssential: false }) });
...
exports.MBParams = (0, tslib_1.__assign)({}, MembraneSphereParams);
