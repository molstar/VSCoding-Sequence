            ...
            switch (_b.label) {
                case 0:
                    if (params.preset.adjustStyle) {
                        ...
                        ctx.managers.structure.component.setOptions(tslib_1.__assign(tslib_1.__assign({}, ctx.managers.structure.component.state.options), { visualQuality: 'custom', ignoreLight: true, showHydrogens: false }));
