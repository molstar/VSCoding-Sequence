...
export declare const DnatcoConfalPyramids: import("../../../mol-state/transformer").StateTransformer<PluginBehavior.Category, PluginBehavior.Behavior, {
    autoAttach: boolean;
    showToolTip: boolean;
}>;
export declare function confalPyramidLabel(halfPyramid: ConfalPyramidsTypes.HalfPyramid): string;
