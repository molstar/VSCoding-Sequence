...
var PyramidsColors = (0, color_1.ColorMap)({
...
function ConfalPyramidsColorTheme(ctx, props) {
    ...
    return {
        ...
        legend: (0, legend_1.TableLegend)((0, type_helpers_1.ObjectKeys)(colorMap).map(function (k) { return [k.replace('_', ' '), colorMap[k]]; }).concat([['Error', ErrorColor]])),
    };
}
