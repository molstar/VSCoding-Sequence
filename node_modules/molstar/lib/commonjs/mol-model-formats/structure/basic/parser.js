...
function createStandardModel(data, atom_site, sourceIndex, entities, properties, format, previous) {
    ...
    if (previous && atomic.sameAsPrevious) {
        return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, previous), { id: uuid_1.UUID.create22(), modelNum: modelNum, atomicConformation: atomic.conformation, _dynamicPropertyData: Object.create(null) });
    }
