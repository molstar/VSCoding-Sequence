...
var LightingDemo = /** @class */ (function () {
    ...
    LightingDemo.prototype.setPreset = function (preset) {
        ...
        commands_1.PluginCommands.Canvas3D.SetSettings(this.plugin, { settings: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, props), { multiSample: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, this.plugin.canvas3d.props.multiSample), props.multiSample), renderer: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, this.plugin.canvas3d.props.renderer), props.renderer), postprocessing: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, this.plugin.canvas3d.props.postprocessing), props.postprocessing) }) });
    };
