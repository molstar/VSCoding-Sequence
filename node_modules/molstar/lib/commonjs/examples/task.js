...
function test1() {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                    t = mol_task_1.Task.create('test', function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () { return (0, tslib_1.__generator)(this, function (_a) {
                        return [2 /*return*/, 1];
                    }); }); });
...
function createTask(delayMs, r) {
    var _this = this;
    return mol_task_1.Task.create('delayed value ' + r, function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function abortAfter(delay) {
    var _this = this;
    return mol_task_1.Task.create('abort after ' + delay, function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
...
function testTree() {
    var _this = this;
    return mol_task_1.Task.create('test o', function (ctx) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
...
exports.ms = (0, mol_task_1.MultistepTask)('ms-task', ['step 1', 'step 2', 'step 3'], function (p, step, ctx) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
    var child;
    return (0, tslib_1.__generator)(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                child = mol_task_1.Task.create('chunked', function (ctx) { return (0, tslib_1.__awaiter)(void 0, void 0, void 0, function () {
                    var s;
                    return (0, tslib_1.__generator)(this, function (_a) {
                        switch (_a.label) {
