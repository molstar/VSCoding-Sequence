...
export declare type Sources = typeof Sources;
export declare const Base: {
    id: Type.Str;
    identifier: Type.Str;
    mapping_group_id: Type.Int;
};
export declare type Base = typeof Base;
...
export declare type mapping = typeof mapping;
export declare const Pfam: {
    description: Type.Str;
};
export declare type Pfam = typeof Pfam;
export declare const InterPro: {
    name: Type.Str;
};
export declare type InterPro = typeof InterPro;
...
export declare type CATH = typeof CATH;
export declare const EC: {
    accepted_name: Type.Str;
    reaction: Type.Str;
    systematic_name: Type.Str;
};
export declare type EC = typeof EC;
export declare const UniProt: {
    name: Type.Str;
};
export declare type UniProt = typeof UniProt;
export declare const SCOP: {
    sccs: Type.Str;
    description: Type.Str;
};
export declare type SCOP = typeof SCOP;
export declare const GO: {
    category: Type.Str;
    definition: Type.Str;
    name: Type.Str;
};
export declare type GO = typeof GO;
