...
var S = (0, tslib_1.__importStar)(require("./schemas"));
...
function getDomainInfo(id, mapping_group_id, data, schema) {
    ...
    return (0, tslib_1.__assign)({ id: id, mapping_group_id: mapping_group_id, identifier: data.identifier }, props);
}
function getDomain(name, schema, allData) {
    ...
    return domains.length > 0 ? {
        name: name,
        domains: db_1.Table.ofRows((0, tslib_1.__assign)((0, tslib_1.__assign)({}, S.Base), schema), domains),
