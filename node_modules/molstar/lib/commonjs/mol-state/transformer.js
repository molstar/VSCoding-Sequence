...
(function (Transformer) {
    ...
    (function (Builder) {
        function root(namespace, info) {
            return function (def) { return create(namespace, (0, tslib_1.__assign)({ name: info.name, from: info.from instanceof Array ? info.from : [info.from], to: info.to instanceof Array ? info.to : [info.to], display: typeof info.display === 'string'
                    ? { name: info.display }
                    : !!info.display
                        ? info.display
