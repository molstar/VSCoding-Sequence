...
export type EntitySubtype = (mmCIF_Schema['entity_poly']['type']['T'] | mmCIF_Schema['pdbx_entity_branch']['type']['T'] | 'ion' | 'lipid' | 'peptide-like');
...
export type StructAsym = Table.Row<Pick<mmCIF_Schema['struct_asym'], 'id' | 'entity_id'> & {
