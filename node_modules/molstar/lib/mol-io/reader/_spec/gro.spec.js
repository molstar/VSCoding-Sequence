...
describe('gro reader', function () {
    it('basic', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, parseGRO(groString).run()];
                case 1:
                    parsed = _a.sent();
                    if (parsed.isError) {
                        console.log(parsed);
    ...
    it('high precision', function () { return __awaiter(void 0, void 0, void 0, function () {
        var parsed, groFile, data, header, atoms;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, parseGRO(groStringHighPrecision).run()];
                case 1:
                    parsed = _a.sent();
                    if (parsed.isError) {
                        console.log(parsed);
...
//# sourceMappingURL=gro.spec.js.map