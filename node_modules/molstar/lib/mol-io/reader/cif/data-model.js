...
(function (CifField) {
    ...
    function ofStrings(values) {
        ...
        var valueKind = function (row) {
            ...
            if (l > 1)
                return 0 /* Column.ValueKind.Present */;
            if (l === 0)
                return 1 /* Column.ValueKind.NotPresent */;
            var c = v.charCodeAt(0);
            if (c === 46 /* . */)
                return 1 /* Column.ValueKind.NotPresent */;
            if (c === 63 /* ? */)
                return 2 /* Column.ValueKind.Unknown */;
            return 0 /* Column.ValueKind.Present */;
        };
        return {
            __array: void 0,
    ...
    function ofNumbers(values) {
        ...
        var valueKind = function (row) { return 0 /* Column.ValueKind.Present */; };
...
export function getCifFieldType(field) {
    ...
    for (var i = 0, _i = field.rowCount; i < _i; i++) {
        ...
        if (k !== 0 /* Column.ValueKind.Present */) {
            undefinedCount++;
            continue;
        }
        var type = getNumberType(field.str(i));
        if (type === 0 /* NumberType.Int */)
            continue;
        else if (type === 1 /* NumberType.Float */)
            floatCount++;
        else {
