...
(function (ArrayEncoding) {
    ...
    function uint8(data) {
        return {
            encodings: [{ kind: 'ByteArray', type: 4 /* Encoding.IntDataType.Uint8 */ }],
            data: data
        };
    }
    function int8(data) {
        return {
            encodings: [{ kind: 'ByteArray', type: 1 /* Encoding.IntDataType.Int8 */ }],
            data: new Uint8Array(data.buffer, data.byteOffset)
        };
    }
    var writers = (_a = {},
        _a[2 /* Encoding.IntDataType.Int16 */] = function (v, i, a) { v.setInt16(2 * i, a, true); },
        _a[5 /* Encoding.IntDataType.Uint16 */] = function (v, i, a) { v.setUint16(2 * i, a, true); },
        _a[3 /* Encoding.IntDataType.Int32 */] = function (v, i, a) { v.setInt32(4 * i, a, true); },
        _a[6 /* Encoding.IntDataType.Uint32 */] = function (v, i, a) { v.setUint32(4 * i, a, true); },
        _a[32 /* Encoding.FloatDataType.Float32 */] = function (v, i, a) { v.setFloat32(4 * i, a, true); },
        _a[33 /* Encoding.FloatDataType.Float64 */] = function (v, i, a) { v.setFloat64(8 * i, a, true); },
        _a);
    var byteSizes = (_b = {},
        _b[2 /* Encoding.IntDataType.Int16 */] = 2,
        _b[5 /* Encoding.IntDataType.Uint16 */] = 2,
        _b[3 /* Encoding.IntDataType.Int32 */] = 4,
        _b[6 /* Encoding.IntDataType.Uint32 */] = 4,
        _b[32 /* Encoding.FloatDataType.Float32 */] = 4,
        _b[33 /* Encoding.FloatDataType.Float64 */] = 8,
        _b);
    function byteArray(data) {
        var type = Encoding.getDataType(data);
        if (type === 1 /* Encoding.IntDataType.Int8 */)
            return int8(data);
        else if (type === 4 /* Encoding.IntDataType.Uint8 */)
            return uint8(data);
