...
var Mol2Encoder = /** @class */ (function (_super) {
    ...
    Mol2Encoder.prototype.mapToSybyl = function (label_atom_id1, type_symbol1, bondMap) {
        ...
        if (type_symbol1 === 'C') { // 1.6
            ...
            if (numBonds >= 2 && this.count(bonds, this, function (_k, v) { return BondType.is(16 /* Aromatic */, v.flags); }) >= 2)
    ...
    Mol2Encoder.prototype.isNpl3 = function (nonmets, bondMap) {
        ...
        while (!result.done) {
            ...
            if (this.count(adjacentBonds, this, function (_k, v) { return v.order > 1 || BondType.is(16 /* Aromatic */, v.flags); })) {
