...
export class Mol2Encoder extends LigandEncoder {
            ...
            if (bondMap === null || bondMap === void 0 ? void 0 : bondMap.map) {
                bondMap.map.get(label_atom_id1).forEach((bond, label_atom_id2) => {
                    ...
                    if (i1 < i2) {
                        ...
                        const ar = BondType.is(16 /* BondType.Flag.Aromatic */, flags);
    ...
    mapToSybyl(label_atom_id1, type_symbol1, bondMap) {
        ...
        if (type_symbol1 === 'C') { // 1.6
            ...
            if (numBonds >= 2 && this.count(bonds, this, (_k, v) => BondType.is(16 /* BondType.Flag.Aromatic */, v.flags)) >= 2)
    ...
    isNpl3(nonmets, bondMap) {
        ...
        while (!result.done) {
            ...
            if (this.count(adjacentBonds, this, (_k, v) => v.order > 1 || BondType.is(16 /* BondType.Flag.Aromatic */, v.flags))) {
