...
export declare function getUnitConformationAndRadius(structure: Structure, unit: Unit, props: CommonSurfaceProps): {
    position: {
...
export declare function getStructureConformationAndRadius(structure: Structure, ignoreHydrogens: boolean, traceOnly: boolean): {
    position: {
