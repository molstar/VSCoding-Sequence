    ...
    PluginContext.prototype.initViewer = function (canvas, container, canvas3dContext) {
        ...
        try {
            ...
            if (canvas3dContext) {
                ...
                this.canvas3dContext = Canvas3DContext.fromCanvas(canvas, { antialias: antialias, preserveDrawingBuffer: preserveDrawingBuffer, pixelScale: pixelScale, pickScale: pickScale, pickPadding: pickPadding, enableWboit: enableWboit, preferWebGl1: preferWebGl1 });
            }
