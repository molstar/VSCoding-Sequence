...
describe('ordered set', function () {
    function ordSetToArray(set) {
        var ret = [];
        for (var i = 0, _i = OrderedSet.size(set); i < _i; i++)
    ...
    var empty = OrderedSet.Empty;
    var singleton10 = OrderedSet.ofSingleton(10);
    var range1_4 = OrderedSet.ofRange(1, 4);
    var arr136 = OrderedSet.ofSortedArray([1, 3, 6]);
    var arr12369 = OrderedSet.ofSortedArray([1, 2, 3, 6, 9]);
    var iB = function (s, e) { return Interval.ofBounds(s, e); };
    testEq('empty', empty, []);
    ...
    it('union AA6', function () { return expect(OrderedSet.union(arr136, OrderedSet.ofSortedArray([1, 3, 6]))).toBe(arr136); });
    ...
    it('intersect AA1', function () { return expect(OrderedSet.union(arr136, OrderedSet.ofSortedArray([1, 3, 6]))).toBe(arr136); });
    ...
    it('foreach', function () {
        var int = OrderedSet.ofBounds(1, 3), set = OrderedSet.ofSortedArray([2, 3, 4]);
        expect(OrderedSet.forEach(int, function (v, i, ctx) { return ctx[i] = v; }, [])).toEqual([1, 2]);
        expect(OrderedSet.forEach(set, function (v, i, ctx) { return ctx[i] = v; }, [])).toEqual([2, 3, 4]);
    });
});
