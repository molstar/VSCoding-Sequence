...
var AssemblySymmetryControls = /** @class */ (function (_super) {
    ...
    AssemblySymmetryControls.prototype.renderEnable = function () {
        ...
        if (!pivot.cell.parent)
            return null;
        return _jsx(ApplyActionControl, { state: pivot.cell.parent, action: EnableAssemblySymmetry3D, initiallyCollapsed: true, nodeRef: pivot.cell.transform.ref, simpleApply: { header: 'Enable', icon: CheckSvg } }, void 0);
    };
    AssemblySymmetryControls.prototype.renderNoSymmetries = function () {
        return _jsx("div", __assign({ className: 'msp-row-text' }, { children: _jsx("div", { children: "No Symmetries for Assembly" }, void 0) }), void 0);
    };
    ...
    AssemblySymmetryControls.prototype.renderParams = function () {
        return _jsx(_Fragment, { children: _jsx(ParameterControls, { params: this.params, values: this.values, onChangeValues: this.paramsOnChange }, void 0) }, void 0);
    };
