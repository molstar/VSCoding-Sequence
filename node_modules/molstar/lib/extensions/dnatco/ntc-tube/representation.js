...
function createNtCTubeSegmentsIterator(structureGroup) {
    ...
    const data = (_b = (_a = NtCTubeProvider.get(structure.model)) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.data;
    if (!data)
...
function segmentCount(structure, props) {
    ...
    if (quality === 'custom')
        ...
        const autoQuality = getStructureQuality(structure);
