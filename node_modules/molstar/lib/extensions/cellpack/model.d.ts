...
export declare const LoadCellPackModel: StateAction<PSO.Root, void, PD.Normalize<{
    source: PD.NamedParams<"InfluenzaModel2.json" | "blood_hiv_immature_inside.json" | "HIV_immature_model.json" | "Blood_HIV.json" | "HIV-1_0.1.6-8_mixed_radii_pdb.json" | "influenza_model1.json" | "ExosomeModel.json" | "MycoplasmaGenitalium.json", "id"> | PD.NamedParams<Asset.File | null, "file">;
    baseUrl: string;
