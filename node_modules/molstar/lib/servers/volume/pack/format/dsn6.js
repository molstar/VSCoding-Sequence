...
export async function readSlices(data) {
    ...
    const { byteCount } = getDsn6Counts(originalHeader);
    ...
    await parseDsn6Values(originalHeader, buffer, slices.values, header.littleEndian);
...
export const Dsn6Provider = { readHeader, readSlices };
