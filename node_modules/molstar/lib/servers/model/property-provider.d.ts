...
export declare type AttachModelProperty = (args: {
    model: Model;
    params: any;
    cache: any;
}) => Promise<any>;
export declare type AttachModelProperties = (args: {
    model: Model;
    params: any;
    cache: any;
}) => Promise<any>[];
export declare type ModelPropertiesProvider = (model: Model, cache: any) => Promise<any>[];
