...
var Viewer = /** @class */ (function () {
    function Viewer(elementOrId, colors, showButtons) {
        ...
        var _a;
        var o = __assign(__assign({}, DefaultViewerOptions), {
        ...
        this.plugin.behaviors.canvas3d.initialized.subscribe(function (v) {
            if (v) {
                PluginCommands.Canvas3D.SetSettings(_this.plugin, { settings: {
                        renderer: __assign(__assign({}, _this.plugin.canvas3d.props.renderer), { backgroundColor: ColorNames.white }),
                        camera: __assign(__assign({}, _this.plugin.canvas3d.props.camera), { helper: { axes: { name: 'off', params: {} } } })
                    } });
            }
        });
    }
