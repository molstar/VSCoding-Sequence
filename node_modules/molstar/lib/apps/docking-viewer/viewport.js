...
function shinyStyle(plugin) {
    return PluginCommands.Canvas3D.SetSettings(plugin, { settings: {
            ...
            postprocessing: __assign(__assign({}, plugin.canvas3d.props.postprocessing), { occlusion: { name: 'off', params: {} }, outline: { name: 'off', params: {} } })
        } });
}
                ...
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        representations = {
                            ...
                            interactions: builder.buildRepresentation(update, components.interactions, { type: InteractionsRepresentationProvider, typeParams: __assign(__assign({}, typeParams), { material: CustomMaterial }), color: InteractionTypeColorThemeProvider }, { tag: 'interactions' }),
...
var ViewportComponent = /** @class */ (function (_super) {
    ...
    ViewportComponent.prototype.render = function () {
        ...
        return _jsxs(_Fragment, { children: [_jsx(Viewport, {}, void 0), this.showButtons && _jsxs("div", __assign({ className: 'msp-viewport-top-left-controls' }, { children: [_jsx("div", __assign({ style: { marginBottom: '4px' } }, { children: _jsx(Button, __assign({ onClick: this.structurePreset }, { children: "Structure" }), void 0) }), void 0), _jsx("div", __assign({ style: { marginBottom: '4px' } }, { children: _jsx(Button, __assign({ onClick: this.illustrativePreset }, { children: "Illustrative" }), void 0) }), void 0), _jsx("div", __assign({ style: { marginBottom: '4px' } }, { children: _jsx(Button, __assign({ onClick: this.surfacePreset }, { children: "Surface" }), void 0) }), void 0), _jsx("div", __assign({ style: { marginBottom: '4px' } }, { children: _jsx(Button, __assign({ onClick: this.interactionsPreset }, { children: "Interactions" }), void 0) }), void 0)] }), void 0), _jsx(VPControls, {}, void 0), _jsx(BackgroundTaskProgress, {}, void 0), _jsxs("div", __assign({ className: 'msp-highlight-toast-wrapper' }, { children: [_jsx(LociLabels, {}, void 0), _jsx(Toasts, {}, void 0)] }), void 0)] }, void 0);
    };
